...
about:AddParagraph("更新以及反馈QQ群834451572")
about:AddParagraph("更新日志将黑火药和备用战场脚本移除(因为用不了)同时增加一堆服务器脚本")
...
Tab1Section:NewToggle("无限跳跃"," ",function()
...
Tab1Section:NewButton("穿墙","",function()
